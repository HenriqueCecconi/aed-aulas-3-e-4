...
{
    Element* data;
    int size; //Quantos elementos atualmente o array esta armazenando
    int capacity; //Quantos elementos atualmente o array pode armazenar
};
...
void array_dinamico_resize(ArrayDinamico* array, int new_capacity){
    ...
    Element* new_array = realloc(array->data, capacity);
    if(new_array != NULL){
